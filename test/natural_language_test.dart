...
class MockNaturalLanguagePlatform
    with MockPlatformInterfaceMixin
    implements NaturalLanguagePlatform {
  @override
...
void main() {
  final NaturalLanguagePlatform initialPlatform =
      NaturalLanguagePlatform.instance;
  ...
  test('getLanguageHypotheses', () async {
    ...
    expect(await naturalLanguagePlugin.getLanguageHypotheses("test", 3),
        {"en": 0.6});
  });
